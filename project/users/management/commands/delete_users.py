...
class Command(BaseCommand):
    help = "Deletes all races, users, locations, and leaderboard entries."
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS("All races, users, locations, and leaderboard entries have been deleted"))
